...
$cookies_halo = "CountHalo";
setcookie($cookies_halo, time(),time() + 60 * 60 * 24 * 5);
if(!isset($_COOKIE['CountHalo'])){
    setcookie($cookies_halo, time(),time() + 60 * 60 * 24 * 5);
}else{
    setcookie($cookies_halo, $_COOKIE['CountHalo'] + 1, time(), time() + 60 * 60 * 24 * 5);
}
?>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row details">
          <div class="col-md-4">
            <img style="margin-left: 10pt; height: 180pt; width: 145pt;" src="http://dzaivc.com/halo.jpg" alt="Halo"></div>
            <div class="col-md-8">
            <h3 style="font-size: 18pt">Halo Infinite Standard Edition</h3>
            <div class="details-price">
              $69.99
            </div>
             <div class="details-description" style="font-size: 13pt;"> 
               <p>When all hope is lost and humanity’s fate hangs in the balance, the Master Chief is ready to confront the most ruthless foe he’s ever faced. The legendary Halo series returns with the most expansive Master Chief story yet.</p>
             </div>
...
<div class="row container">
    ...
    <form style="width: 500px;" method="post" action="product_halo.php">
                <div class="col-lg-12 ">
                    ...
                    <div>
                      <input type="hidden" name="games" value="Halo Infinite Standard Edition">
