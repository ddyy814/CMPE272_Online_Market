...
$cookies_spider = "CountSpider";
setcookie($cookies_spider, time(),time() + 60 * 60 * 24 * 5);
if(!isset($_COOKIE['CountSpider'])){
    setcookie($cookies_spider, time(),time() + 60 * 60 * 24 * 5);
}else{
    setcookie($cookies_spider, $_COOKIE['CountSpider'] + 1, time(), time() + 60 * 60 * 24 * 5);
}
?>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row details">
          <div class="col-md-4">
            <img style="margin-left: 10pt; height: 180pt; width: 135pt;" src="http://dzaivc.com/Spider.jpg" alt="spider"></div>
            <div class="col-md-8">
            <h3 style="font-size: 18pt">Marvel's Spider-Man</h3>
...
<div class="row container">
    ...
    <form style="width: 500px;" method="post" action="product_spider.php">
                <div class="col-lg-12 ">
                    ...
                    <div>
                      <input type="hidden" name="games" value="Marvel's Spider-Man">
