...
<div class="row container">
    <div class="col-md-4 ">
        ...
        <div class="row">
            <div class="col-md-6">
                <h3 align="center"><b><?= round($AVERAGE,1);?></b> <i class="fa fa-star" data-rating="2" style="font-size:20px;color:#ff9f00;"></i></h3>
                <p><?=$Total_review;?> Ratings and <?=$Total_review;?> Reviews</p>
            </div>
            <div class="col-md-6">
                <?php
