...
$cookies_gear = "CountGear";
setcookie($cookies_gear, time(),time() + 60 * 60 * 24 * 5);
if(!isset($_COOKIE['CountGear'])){
    setcookie($cookies_gear, time(),time() + 60 * 60 * 24 * 5);
}else{
    setcookie($cookies_gear, $_COOKIE['CountGear'] + 1, time(), time() + 60 * 60 * 24 * 5);
}
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row details">
          <div class="col-md-4">
            <img style="margin-left: 10pt; height: 180pt; width: 145pt;" src="http://dzaivc.com/gear.jpg" alt="Gear"></div>
            <div class="col-md-8">
            <h3 style="font-size: 18pt">Gears Tactics</h3>
            <div class="details-price">
              $69.99
            </div>
             <div class="details-description" style="font-size: 13pt;"> 
               <p>Gears Tactics is the fast-paced, turn-based strategy game set 12 years before the first Gears of War. Cities on the planet Sera are beginning to fall to the monstrous threat rising from underground—the Locust Horde. With the government in disarray, a squad of survivors emerge as humanity's last hope.</p>
             </div>
...
<div class="row container">
    ...
    <form style="width: 500px;" method="post" action="product_gear.php">
                <div class="col-lg-12 ">
                    ...
                    <div>
                      <input type="hidden" name="games" value="Gears Tactics">
