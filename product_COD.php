...
$cookies_cod = "CountCod";
setcookie($cookies_cod, time(),time() + 60 * 60 * 24 * 5);
if(!isset($_COOKIE['CountCod'])){
    setcookie($cookies_cod, time(),time() + 60 * 60 * 24 * 5);
}else{
    setcookie($cookies_cod, $_COOKIE['CountCod'] + 1, time(), time() + 60 * 60 * 24 * 5);
}
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row details">
          <div class="col-md-4">
            <img style="margin-left: -5pt; height: 200pt; width: 190pt;" src="http://dzaivc.com/Call-of-Duty-Black-Ops-Cold-War.jpg" alt="cod"></div>
            <div class="col-md-8">
            <h3 style="font-size: 18pt">Call of Duty: Black Ops Cold War</h3>
...
<div class="row container">
    ...
    <form style="width: 500px;" method="post" action="product_COD.php">
                <div class="col-lg-12 ">
                    ...
                    <div>
                      <input type="hidden" name="games" value="Call of Duty: Black Ops Cold War">
