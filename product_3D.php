...
global $cookies_name;
 $cookies_name = "Mario_3D";
setcookie($cookies_name, time(), time() + 60 * 60 * 24 * 5);
$cookies_mario = "CountMario";
setcookie($cookies_mario, time(),time() + 60 * 60 * 24 * 5);
if(!isset($_COOKIE['CountMario'])){
    setcookie($cookies_mario, time(),time() + 60 * 60 * 24 * 5);
}else{
    setcookie($cookies_mario, $_COOKIE['CountMario'] + 1, time(), time() + 60 * 60 * 24 * 5);
}
?>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row details">
          <div class="col-md-4">
            <img style="margin-left:10pt; height: 210pt; width: 140pt;" src="http://dzaivc.com/3D.jpg" alt="Mario_3D"></div>
            <div class="col-md-8">
            <h3 style="font-size: 18pt">Super Mario 3D All-Stars</h3>
            <div class="details-price">
              $69.99
            </div>
             <div class="details-description" style="font-size: 13pt;"> 
               <p>Run, jump, and dive with ease! Make Mario move using the Nintendo Switch system’s Joy-Con™ controllers. You can also pass a Joy-Con controller to a friend to play the Super Mario Galaxy game in Co-Star Mode*! Mario’s movements are as smooth as ever with HD resolution for each game, while still retaining the look and feel of the originals.</p>
             </div>
...
<div class="row container">
    ...
    <form style="width: 500px;" method="post" action="product_3D.php">
                <div class="col-lg-12 ">
                    ...
                    <div>
                      <input type="hidden" name="games" value="Super Mario 3D All-Stars">
