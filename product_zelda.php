...
$cookies_zelda = "CountZelda";
setcookie($cookies_zelda, time(),time() + 60 * 60 * 24 * 5);
if(!isset($_COOKIE['CountZelda'])){
    setcookie($cookies_zelda, time(),time() + 60 * 60 * 24 * 5);
}else{
    setcookie($cookies_zelda, $_COOKIE['CountZelda'] + 1, time(), time() + 60 * 60 * 24 * 5);
}
?>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row details">
          <div class="col-md-4">
            <img style="margin-left: 10pt; height: 190pt; width: 135pt;" src="http://dzaivc.com/Zelda.jpg" alt="Zelda"></div>
            <div class="col-md-8">
            <h3 style="font-size: 18pt">The Legend of Zelda: Breath of the Wild</h3>
            <div class="details-price">
              $69.99
            </div>
             <div class="details-description" style="font-size: 13pt;"> 
               <p>Travel across vast fields, through forests, and to mountain peaks as you discover what has become of the kingdom of Hyrule in this stunning Open-Air Adventure. Now on Nintendo Switch, your journey is freer and more open than ever. Take your system anywhere, and adventure as Link any way you like.</p>
             </div>
...
<div class="row container">
    ...
    <form style="width: 500px;" method="post" action="product_zelda.php">
                <div class="col-lg-12 ">
                    ...
                    <div>
                      <input type="hidden" name="games" value="The Legend of Zelda: Breath of the Wild">
