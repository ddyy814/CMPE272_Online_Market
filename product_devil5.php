...
$cookies_devil = "CountDevil";
setcookie($cookies_devil, time(),time() + 60 * 60 * 24 * 5);
if(!isset($_COOKIE['CountDevil'])){
    setcookie($cookies_devil, time(),time() + 60 * 60 * 24 * 5);
}else{
    setcookie($cookies_devil, $_COOKIE['CountDevil'] + 1, time(), time() + 60 * 60 * 24 * 5);
}
?>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row details">
          <div class="col-md-4">
            <img style="margin-left: 10pt; height: 180pt; width: 145pt;" src="http://dzaivc.com/devil5.jpg" alt="Devil5"></div>
            <div class="col-md-8">
            <h3 style="font-size: 18pt">Devil May Cry 5 Special Edition</h3>
            <div class="details-price">
              $69.99
            </div>
             <div class="details-description" style="font-size: 13pt;"> 
               <p>Devil May Cry 5 is back, and now upgraded for next-generation consoles! Several years after the Order of the Sword incident, a new demonic threat has invaded our world. It's up to the legendary devil hunters Dante and Nero to stop it, with the newcomer V joining forces with them. </p>
             </div>
...
<div class="row container">
    ...
    <form style="width: 500px;" method="post" action="product_devil5.php">
                <div class="col-lg-12 ">
                    ...
                    <div>
                      <input type="hidden" name="games" value="Devil May Cry 5 Special Edition">
