...
$cookies_aoc = "CountAOC";
setcookie($cookies_aoc, time(),time() + 60 * 60 * 24 * 5);
if(!isset($_COOKIE['CountAOC'])){
    setcookie($cookies_aoc, time(),time() + 60 * 60 * 24 * 5);
}else{
    setcookie($cookies_aoc, $_COOKIE['CountAOC'] + 1, time(), time() + 60 * 60 * 24 * 5);
}
?>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row details">
          <div class="col-md-4">
            <img style="margin-left: 10pt; height: 210pt; width: 140pt;" src="http://dzaivc.com/AOC.jpg" alt="AOC"></div>
            <div class="col-md-8">
            <h3 style="font-size: 18pt">Hyrule Warriors: Age of Calamity</h3>
            <div class="details-price">
              $69.99
            </div>
             <div class="details-description" style="font-size: 13pt;"> 
               <p>From barbaric Bokoblins to towering Lynels, menacing monsters have emerged in droves. In addition to Link and Zelda, take control of characters like the four Champions and a young Impa must use their distinct abilities to carve through hundreds of enemies to save Hyrule from the impending Calamity. </p>
             </div>
...
<div class="row container">
    ...
    <form style="width: 500px;" method="post" action="product_AOC.php">
                <div class="col-lg-12 ">
                    ...
                    <div>
                      <input type="hidden" name="games" value="Hyrule Warriors: Age of Calamity">
