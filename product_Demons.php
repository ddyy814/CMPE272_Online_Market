...
$cookies_soul = "CountSoul";
setcookie($cookies_soul, time(),time() + 60 * 60 * 24 * 5);
if(!isset($_COOKIE['CountSoul'])){
    setcookie($cookies_soul, time(),time() + 60 * 60 * 24 * 5);
}else{
    setcookie($cookies_soul, $_COOKIE['CountSoul'] + 1, time(), time() + 60 * 60 * 24 * 5);
}
?>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row details">
          <div class="col-md-4">
            <img style="margin-left: -10pt; height: 180pt; width: 175pt;" src="http://dzaivc.com/Demons-Souls.jpg" alt="Soul"></div>
            <div class="col-md-8">
            <h3 style="font-size: 18pt">Demon's Souls</h3>
            <div class="details-price">
              $69.99
            </div>
             <div class="details-description" style="font-size: 13pt;"> 
               <p>In his quest for power, the 12th King of Boletaria, King Allant channelled the ancient Soul Arts, awakening a demon from the dawn of time itself, The Old One. With the summoning of The Old One, a colourless fog swept across the land, unleashing nightmarish creatures that hungered for human souls. </p>
             </div>
...
<div class="row container">
    ...
    <form style="width: 500px;" method="post" action="product_Demons.php">
                <div class="col-lg-12 ">
                    ...
                    <div>
                      <input type="hidden" name="games" value="Demon's Souls">
